...
//Store provides all the functions to execute db queries and transaction
type Store interface {
	Querier
	TransferTx(ctx context.Context, arg CreateTransferParams) (TransferTxResult, error)
}

//SQLStore provides all the functions to execute SQL queries and transaction
...
//It creates a transfer record, add money entries and update Accounts balance within a single database transaction  
